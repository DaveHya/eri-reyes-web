  ...
  const statsM = [
    {
     ...
     {
      value: "+3",
      label: "países con proyectos desarrollados",   
    }
  ]
    ...
    <section className="bg-[#f9f6f0] min-h-[480px] relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 py-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 z-10 ">
          <p className="text-[16px] text-gray-500 tracking-wide mb-5">
            {heroTagline} Dirección Creativa | Event Designer | Founder Agencia Experiences 360
          </p>
          <Image src={logoEri} alt="Eri Reyes" /> 
          {/* <h1
